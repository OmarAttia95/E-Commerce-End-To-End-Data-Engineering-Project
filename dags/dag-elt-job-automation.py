...
produce_data_to_kafka = BashOperator(
    ...
    bash_command='python3 /home/omarattia/Projects/e-commerce.py',
    dag=dag,
)
...
process_data_with_spark = BashOperator(
    ...
    bash_command='spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.1 /home/omarattia/Projects/py-spark-processing.py',
    dag=dag,
)
...
shard_and_aggregate_data_with_spark = BashOperator(
    ...
    bash_command='spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.1 /home/omarattia/Projects/pyspark_sharding.py',
    dag=dag,
)
