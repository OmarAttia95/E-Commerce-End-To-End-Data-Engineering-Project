...
log_file = "/path/to/logs/pyspark_kafka_to_parquet.log"  # Replace with your log file path
...
try:
    ...
    output_path = "/path/to/your/PySpark_Loading_Parquets"  # Replace with your output directory path
    ...
    query = json_df.writeStream \
        ...
        .option("checkpointLocation", "/path/to/your/PySpark_Checkpoint")  # Replace with your checkpoint directory path
        .start()
